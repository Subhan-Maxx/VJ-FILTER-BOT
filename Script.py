...
🔒 <b>ғʀᴇᴇ ᴜsᴇʀs</b> ɴᴇᴇᴅ ᴛᴏ ᴄᴏᴍᴘʟᴇᴛᴇ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴏɴᴄᴇ. ᴀғᴛᴇʀ sᴜᴄᴄᴇssғᴜʟ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ, ʏᴏᴜ ɢᴇᴛ <b>ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ғᴏʀ 24 ʜᴏᴜʀs</b>. ᴏɴᴄᴇ ᴛʜᴇ 24 ʜᴏᴜʀs ᴇxᴘɪʀᴇ, sɪᴍᴘʟʏ ᴠᴇʀɪғʏ ᴀɢᴀɪɴ ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ.

🎁 <b>ɴᴇᴡ ᴜsᴇʀ?</b> ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴀᴄᴛɪᴠᴀᴛᴇ ᴀ <b>7-ᴅᴀʏ ғʀᴇᴇ ᴛʀɪᴀʟ</b> ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ.

• /plan - <code>ᴛᴏ ᴄʜᴇᴄᴋ ᴘʟᴀɴ ᴅᴇᴛᴀɪʟs.</code>
• /myplan - <code>ᴛᴏ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴘʟᴀɴ sᴛᴀᴛᴜs.</code>"""
...
• /deleteall - <code>ᴛᴏ ᴅᴇʟᴇᴛᴇ ᴀʟʟ ɪɴᴅᴇxᴇᴅ ғɪʟᴇs ғʀᴏᴍ ᴛʜᴇ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ.</code>"""
    ...
    ADMIN2_TXT = """ʜᴇʟᴘ: Aᴅᴍɪɴ Mᴏᴅs ᴘᴀɢᴇ 𝟸
